            ...
            <section className="container">
                <div className="row about-section">
                    <div className="col-12  col-lg-6 about-left-side ">
                        <div className="about-me">
                            <div className="img">
                                ...
                                <p style={{ marginTop: '10px' }}><strong>Name: </strong>Muhammad</p>
                                <p><strong>Profile: </strong>NodeJS & ReactJS Developer</p>
                    ...
                    <div className="col-12 col-lg-6 about-right-side ">
                        ...
                        <p>An aspiring NodeJS Developer. I lost myself when I dive into the codes. I have completed React and nodeJS. I count myself as a hardworking person. </p>
                        <p>A goal-getter and a self-starter with huge knowledge and proficiency in JavaScript, NodeJS, Python and so on.</p>
                        <p>I have over 2 years of working experience across the entire stack of web development. Adept creation of script using javaScript to convey unique branding and promote sales and marketing opportunities. Supporting intricate Full-stack needs and lending assistance throughout webpage lifecycle.</p>
                    </div>
                </div>
            </section>
